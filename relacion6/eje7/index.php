...
<body>
    <?php
    /*
    a- Crear un directorio o carpeta si no existe.

    b- Sube algún archivo a esta carpeta.

    c- Usa opendir() para abrir un gestor de directorio que nos permita mostrar todos los archivos que hay en esa carpeta. 
    */
    ...
    if ($handle = opendir($directorio)) {//handle=array de todas las fotos
